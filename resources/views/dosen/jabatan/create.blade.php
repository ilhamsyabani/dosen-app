...
<div class="row">
    ...
    <div class="col-lg-8 order-lg-1">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('jabatan.store') }}/" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group mb-4 focused">
                        ...
                        <input type="text" id="nidn_nuptk" class="form-control" name="nidn_nuptk" placeholder="......." value="{{ old('nidn_nuptk') }}" required>
                        @error('nidn_nuptk')
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control @error('jabatan_fungsional') is-invalid @enderror" aria-label="Default select example" name="jabatan_fungsional" id="jabatan_fungsional">
                                ...
                                <option value="Lektor 200" {{ old('jabatan_fungsional') == 'Lektor 200' ? 'selected' : '' }}>Lektor 200</option>
                                <option value="Lektor 300" {{ old('jabatan_fungsional') == 'Lektor 300' ? 'selected' : '' }}>Lektor 300</option>
                                <option value="LK 400" {{ old('jabatan_fungsional') == 'LK 400' ? 'selected' : '' }}>LK 400</option>
                                <option value="LK 550" {{ old('jabatan_fungsional') == 'LK 550' ? 'selected' : '' }}>LK 550</option>
                                <option value="LK 700" {{ old('jabatan_fungsional') == 'LK 700' ? 'selected' : '' }}>LK 700</option>
                                <option value="GB 850" {{ old('jabatan_fungsional') == 'GB 850' ? 'selected' : '' }}>GB 850</option>
                                <option value="GB 1050" {{ old('jabatan_fungsional') == 'GB 1050' ? 'selected' : '' }}>GB 1050</option>
                            </select>
                        ...
                        <div class="form-group mb-4 focused">
                            ...
                            <input type="text" id="jabatan_struktural" class="form-control" name="jabatan_struktural" placeholder="......." value="{{ old('jabatan_struktural') }}" required>
                        ...
                        <div class="form-group mb-4 focused">
                            ...
                            <select class="form-control @error('pangkat') is-invalid @enderror" aria-label="Default select example" name="pangkat" id="pangkat">
                                <option value="Penata Muda Tk 1/IIIb" {{ old('pangkat') == 'Penata Muda Tk 1/IIIb' ? 'selected' : '' }}>Penata Muda Tk 1/IIIb</option>
                                <option value="Penata/IIIc" {{ old('pangkat') == 'Penata/IIIc' ? 'selected' : '' }}>Penata/IIIc</option>
                                <option value="Penata Tk 1/IIId" {{ old('pangkat') == 'Penata Tk 1/IIId' ? 'selected' : '' }}>Penata Tk 1/IIId</option>
                                <option value="Pembina/ Iva" {{ old('pangkat') == 'Pembina/ Iva' ? 'selected' : '' }}>Pembina/ Iva</option>
                                <option value="Pembina Tk 1/Ivb" {{ old('pangkat') == 'Pembina Tk 1/Ivb' ? 'selected' : '' }}>Pembina Tk 1/Ivb</option>
                                <option value="Pembina Utama Muda Ivc" {{ old('pangkat') == 'Pembina Utama Muda Ivc' ? 'selected' : '' }}>Pembina Utama Muda Ivc</option>
                                <option value="Pembina Utama Madya" {{ old('pangkat') == 'Pembina Utama Madya' ? 'selected' : '' }}>Pembina Utama Madya</option>
                                <option value="Ivd" {{ old('pangkat') == 'Ivd' ? 'selected' : '' }}>Ivd</option>
                        ...
                        <div class="form-group mb-4 focused">
                            ...
                            <select class="form-control @error('status_kepegawaian') is-invalid @enderror" aria-label="Default select example" name="status_kepegawaian" id="status_kepegawaian">
                                ...
                                <option value="PTNBH" {{ old('status_kepegawaian') == 'PTNBH' ? 'selected' : '' }}>PTNBH</option>
                                <option value="NIDK" {{ old('status_kepegawaian') == 'NIDK' ? 'selected' : '' }}>NIDK</option>
                            </select>
                        ...
                        <div class="form-group mb-4 focused">
                            ...
                            <select class="form-control @error('status_aktif') is-invalid @enderror" aria-label="Default select example" name="status_aktif" id="status_aktif">
                                ...
                                <option value="Tugas Belajar Mandiri" {{ old('status_aktif') == 'Tugas Belajar Mandiri' ? 'selected' : '' }}>Tugas Belajar Mandiri</option>
                                <option value="Beasiswa" {{ old('status_aktif') == 'Beasiswa' ? 'selected' : '' }}>Beasiswa</option>
                            </select>
                            @error('status_aktif')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
