        ...
        <div class="row">
            ...
            <div class="col-lg-8 order-lg-1">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('kompetensi.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="mb-3">
                                    <label for="nama_kompetensi" class="form-label">Jenis<span class="small text-danger">*</span></label>
                                    <select class="form-select @error('nama_kompetensi') is-invalid @enderror"
                                        ...
                                        <option value="Profesi" {{ old('nama_kompetensi') == 'Profesi' ? 'selected' : '' }}>
                                            Profesi
                                        </option>
                                        <option value="Kompetensi" {{ old('nama_kompetensi') == 'Kompetensi' ? 'selected' : '' }}>
                                            Kompetensi
                                        </option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tahun_sertifikat') is-invalid @enderror"
                                        id="tahun_sertifikat" name="tahun_sertifikat" value="{{ old('tahun_sertifikat') }}"
                                        maxlength="4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('institusi_sertifikat') is-invalid @enderror"
                                        id="institusi_sertifikat" name="institusi_sertifikat"
                                        value="{{ old('institusi_sertifikat') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bidang_kompetensi') is-invalid @enderror"
                                        id="bidang_kompetensi" name="bidang_kompetensi"
                                        value="{{ old('bidang_kompetensi') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jam_pelajaran') is-invalid @enderror"
                                        id="jam_pelajaran" name="jam_pelajaran" value="{{ old('jam_pelajaran') }}">
                                    @error('jam_pelajaran')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_diklat') is-invalid @enderror"
                                        id="jenis_diklat" name="jenis_diklat" value="{{ old('jenis_diklat') }}">
                                    @error('jenis_diklat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" class="form-control @error('sk_penugasan') is-invalid @enderror"
