        ...
        <div class="row">
            ...
            <div class="col-lg-8 order-lg-1">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pengajaran.update', $pengajaran) }}/" method="POST"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('nama_matkul') is-invalid @enderror"
                                    id="nama_matkul" name="nama_matkul"
                                    value="{{ old('nama_matkul', $pengajaran->nama_matkul) }}">
                                @error('nama_matkul')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control @error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran"
                                    ...
                                    @foreach (range(date('Y'), 2020) as $year)
                                        <option value="{{ $year }}"
                                            {{ old('tahun_ajaran', $pengajaran->tahun_ajaran) == $year ? 'selected' : '' }}>
                                            {{ $year }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control @error('semester') is-invalid @enderror" id="semester"
                                    name="semester">
                                    <option value="Ganjil"
                                        {{ old('semester', $pengajaran->semester) == 'Ganjil' ? 'selected' : '' }}>Ganjil
                                    </option>
                                    <option value="Genap"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control @error('sks') is-invalid @enderror" id="sks"
                                    ...
                                    <option value="3" {{ old('sks', $pengajaran->sks) == '3' ? 'selected' : '' }}>3
                                    </option>
                                    <option value="4" {{ old('sks', $pengajaran->sks) == '4' ? 'selected' : '' }}>4
                                    </option>
                                </select>
                                @error('sks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control @error('jenjang') is-invalid @enderror" id="jenjang"
                                    name="jenjang">
                                    <option value="S1"
                                        {{ old('jenjang', $pengajaran->jenjang) == 'S1' ? 'selected' : '' }}>S1</option>
                                    <option value="S2"
                                        {{ old('jenjang', $pengajaran->jenjang) == 'S2' ? 'selected' : '' }}>S2</option>
                                    <option value="S3"
                                        {{ old('jenjang', $pengajaran->jenjang) == 'S3' ? 'selected' : '' }}>S3</option>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('prodi') is-invalid @enderror"
                                    id="prodi" name="prodi" value="{{ old('prodi', $pengajaran->prodi) }}">
                                @error('prodi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control @error('bentuk') is-invalid @enderror" id="bentuk"
                                    name="bentuk">
                                    <option value="Tim"
                                        {{ old('bentuk', $pengajaran->bentuk) == 'Tim' ? 'selected' : '' }}>Tim</option>
                                    <option value="Individu"
                                        {{ old('bentuk', $pengajaran->bentuk) == 'Individu' ? 'selected' : '' }}>Individu
                                    </option>
                                </select>
                                @error('bentuk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mt-4">
                                ...
                                @if ($pengajaran->rpp)
                                    <div class="mt-2">
                                        <a href="{{ asset('storage/' . $pengajaran->rpp) }}" target="_blank"
                                            class="btn btn-outline-primary">Lihat SK Penugasan</a>
                                    </div>
                                @else
                            ...
                            <div class="mt-4">
                                ...
                                @if ($pengajaran->presensi)
                                    <div class="mt-2">
                                        <a href="{{ asset('storage/' . $pengajaran->presensi) }}" target="_blank"
                                            class="btn btn-outline-primary">Lihat SK Penugasan</a>
                                    </div>
                                @else
                                    <small class="text-muted">Belum ada file yang diupload.</small>
                            ...
                            <div class="mt-4">
                                ...
                                @if ($pengajaran->daftar_nilai)
                                    <div class="mt-2">
                                        <a href="{{ asset('storage/' . $pengajaran->daftar_nilai) }}" target="_blank"
                                            class="btn btn-outline-primary">Lihat SK Penugasan</a>
                                    </div>
                                @else
                                    <small class="text-muted">Belum ada file yang diupload.</small>
                            ...
                            <div class="mt-4">
                                ...
                                @if ($pengajaran->sk_mengajar)
                                    <div class="mt-2">
                                        <a href="{{ asset('storage/' . $pengajaran->sk_mengajar) }}" target="_blank"
                                            class="btn btn-outline-primary">Lihat SK Penugasan</a>
                                    </div>
                                @else
                                    <small class="text-muted">Belum ada file yang diupload.</small>
