        ...
        <div class="row">
            ...
            <div class="col-lg-8 order-lg-1">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('bahan.store', $bahan) }}/" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            @include('components.input-year', [
                                'label' => 'Tahun Ajaran',
                                'name' => 'tahun_ajaran',
                                'value' => old('tahun_ajaran', $bahan->tahun_ajaran),
                            ...
                            @include('components.input-select', [
                                'label' => 'Jenjang',
                                'name' => 'jenjang',
                                'value' => old('jenjang', $bahan->janjang),
                            ...
                            @include('components.input-text', [
                                'label' => 'ISBN',
                                'name' => 'isbn',
                                'value' => old('isbn', $bahan->isbn),
                            ])

                            @include('components.input-date', [
                                'label' => 'Bulan/Tahun',
                                'name' => 'bulan',
                                'value' => old('bulan', isset($data) ? $data->tanggal->format('Y-m') : '', $bahan->bulan),
                            ...
                            @include('components.input-text', [
                                'label' => 'Penerbit',
                                'name' => 'penerbit',
                                'value' => old('penerbit', $bahan->penerbit),
                            ])

                            @include('components.input-text', [
                                'label' => 'Penulis',
                                'name' => 'penulis',
                                'value' => old('penulis', $bahan->penulis),
                            ])

                            @include('components.input-select', [
                                'label' => 'Bahan Ajar',
                                'name' => 'format',
                                'value' => old('format', $bahan->format),
