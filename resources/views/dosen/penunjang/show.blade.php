                    ...
                    <div class="card-header align-middle">
                        <div class="row py-2">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="{{ route('penunjang.edit', $penunjang->id) }}"
                                    class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('penunjang.destroy', $penunjang->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <p class="p-0"><strong class="d-block">Surat Tugas penunjang :</strong>
                                    @if ($penunjang->surat_tugas)
                                        <a href="{{ asset('storage/' . $penunjang->surat_tugas) }}"
                            ...
                            <div class="col-md-4">
                                <p class="p-0"><strong class="d-block">SK :</strong>
                                    @if ($penunjang->sk)
                                        <a href="{{ asset('storage/' . $penunjang->sk) }}"
                            ...
                            <div class="col-md-4">
                                <p class="p-0"><strong class="d-block">Sertifikat :</strong>
                                    @if ($penunjang->sertifikat)
                                        <a href="{{ asset('storage/' . $penunjang->sertifikat) }}"
