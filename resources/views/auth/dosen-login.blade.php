                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-1">Login Dosen</h1>
                                <p class="text-muted small mb-4">Masuk menggunakan email dan password</p>
                            </div>
                                ...
                                @if (Route::has('redirect'))
                                    <div class="mb-3 text-center">
                                        <a href="{{ route('redirect') }}"
                                            ...
                                            <span class="ms-2 fs-6 flex-grow-1">Masuk dengan Google</span>
                                        </a>
                                    </div>
                                @endif

                                <div class="text-center mt-3">
                                    <a class="small" href="{{ route('login') }}">Login sebagai Admin</a>
                                </div>
                            </form>
                        </div>
                    </div>
